...
class Announcement(models.Model):
    ...
    sage = models.BooleanField(u"Sage", default=False, help_text=u"チェックを入れるとトップページのお知らせに表示させません。また各ユーザーに対する通知も飛ばしません")
    # Uneditable
    ...
    class Meta:
        ordering = ('-created_at',)
        unique_together = ('title', 'publish_at_date',)
        verbose_name = u"お知らせ"
    ...
    def get_absolute_url(self):
        if self.pub_state == 'draft':
            ...
            return ("announcements-announcement-update", (self.pk,))
        return ("announcements-announcement-detail", (self.pk,))
